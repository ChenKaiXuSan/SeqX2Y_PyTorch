...
class ActivationsAndGradients_2D:
    ...
    def __call__(self, x, batch_2D, future_seq):
        self.gradients = []
        self.activations = []
        return self.model(x, batch_2D, future_seq)
...
class BaseCAM_2D:
    def __init__(
        ...
        self.activations_and_grads = ActivationsAndGradients_2D(self.model, target_layers, reshape_transform)
