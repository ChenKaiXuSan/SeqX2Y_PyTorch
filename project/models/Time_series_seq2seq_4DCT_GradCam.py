'''
File: /home/xchen/workspace/SeqX2Y_PyTorch/project/models/Time_series_seq2seq_4DCT_GradCam.py
Project: /home/xchen/workspace/SeqX2Y_PyTorch/project/models
...
class Encoder3DCNN(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.pool1 = nn.MaxPool3d(kernel_size=(1, 2, 2), stride=(1, 2, 2)) # 原本老陈写的是这个，2d正方形图片整个输入用这个
...
class TimeSeq2Seq4DCT(nn.Module):
    ...
    def __init__(self, nf, in_chan, size1, size2, size3):
        ...
        super(TimeSeq2Seq4DCT, self).__init__()
        # BxCx1xDxWxH
        ...
        # add 3D CNN encoder for 2D images in time series
        self.encoder3d_cnn = Encoder3DCNN(in_channels=3, out_channels=nf)
    ...
    def forward(self, x, batch_2D, future_seq=0, hidden_state=None, grad_cam_flag=False):
        ...
        # set grad_cam_flag to True to enable Grad-CAM
        if grad_cam_flag:
            grad_cam = GradCAM(self.encoder_decoder, target_layer=self.encoder_decoder.encoder3d_cnn.conv4)
