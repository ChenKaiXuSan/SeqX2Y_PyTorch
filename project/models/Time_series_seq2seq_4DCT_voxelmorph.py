...
class EncoderDecoderConvLSTM(nn.Module):
    ...
    def autoencoder(self, x, seq_len, rpm_tensor, future_step, h_t4, c_t4, h_t5, c_t5, h_t6, c_t6, h_t7, c_t7): #!origin
 ...
 #------------------myself add 1d rpm -------------------------------------------------- 
            ...
            # # encoder_vector = h_t5 + time_series_fat
            # encoder_vector = h_t5 # TODO: fuse location feature 
 #------------------org 2d ------------------------------------------------------------ 
...
#------------------org 2d -------------------------------------------------- 
            ...
            # # decoder_vector = h_t7 + time_series_fat
            # decoder_vector = h_t7 # TODO: fuse location
...
#------------------nadeemlab ORG--注意：原本的No2D中不需要解开此代码------------------------
    ...
    def forward(self, x, rpm_tensor, future_seq=0, hidden_state=None):
        ...
        outputs = self.autoencoder(x, seq_len, rpm_tensor, future_seq, h_t4, c_t4, h_t5, c_t5, h_t6, c_t6, h_t7, c_t7) # !origin
